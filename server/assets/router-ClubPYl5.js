...
const appCss = "/assets/styles-Bf5mtcIW.css";
const nav = [
  { to: "/", label: "Projects" },
...
function AppShell() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen flex flex-col", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "border-b border-rule bg-background/80 backdrop-blur sticky top-0 z-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-6 h-16 flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/", className: "flex items-center gap-3 group", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 rounded-md bg-primary text-primary-foreground grid place-items-center font-display font-semibold", children: "E" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "leading-tight", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-display text-lg", children: "Evidentia" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "label-eyebrow", children: "Evidence Gap Mapping" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "flex items-center gap-1", children: nav.map((n) => {
        const active = location.pathname === n.to;
        return /* @__PURE__ */ jsxRuntimeExports.jsx(
          Link,
          {
            to: n.to,
            className: `px-3 py-1.5 text-sm rounded-md transition-colors ${active ? "bg-primary text-primary-foreground" : "text-muted-foreground hover:text-foreground hover:bg-muted"}`,
            children: n.label
          },
          n.to
        );
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "border-t border-rule mt-16", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-6 py-6 flex items-center justify-between text-xs text-muted-foreground", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "label-eyebrow", children: "Evidentia · v0.1" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "For research support. Not for direct clinical decision-making." })
    ] }) })
  ] });
}
...
const Route$5 = createRootRouteWithContext()({
  head: () => ({
    meta: [
      ...
      { title: "Evidentia · Clinical Evidence Gap Mapping" },
      { name: "description", content: "Turn clinical questions into structured evidence maps, gap analysis, and ranked research opportunities." },
      { name: "author", content: "Evidentia" },
      { property: "og:title", content: "Evidentia · Clinical Evidence Gap Mapping" },
      { property: "og:description", content: "Structured PICO, evidence maps, and gap-driven research prioritisation." },
...
const $$splitComponentImporter$4 = () => import("./new-Brs28wG0.js");
const Route$4 = createFileRoute("/new")({
  component: lazyRouteComponent($$splitComponentImporter$4, "component"),
  head: () => ({
    meta: [{
      title: "New project · Evidentia"
    }]
  })
});
const $$splitComponentImporter$3 = () => import("./index-ClfVFArP.js");
const Route$3 = createFileRoute("/")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Your evidence-mapping projects."
    }]
  })
});
const $$splitComponentImporter$2 = () => import("./projects._projectId-BmwVYMr7.js");
const Route$2 = createFileRoute("/projects/$projectId")({
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./projects._projectId.index-DG4CmS5i.js");
const Route$1 = createFileRoute("/projects/$projectId/")({
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./projects._projectId._tab-gHV288sg.js");
const Route2 = createFileRoute("/projects/$projectId/$tab")({
  component: lazyRouteComponent($$splitComponentImporter, "component")
});
const NewRoute = Route$4.update({
  id: "/new",
  path: "/new",
...
const ProjectsProjectIdIndexRoute = Route$1.update({
  id: "/",
  path: "/",
  getParentRoute: () => ProjectsProjectIdRoute
});
const ProjectsProjectIdTabRoute = Route2.update({
  id: "/$tab",
  path: "/$tab",
  getParentRoute: () => ProjectsProjectIdRoute
});
const ProjectsProjectIdRouteChildren = {
  ProjectsProjectIdTabRoute,
