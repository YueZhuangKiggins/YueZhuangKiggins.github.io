// Demo data shown across the app. Everything renders deterministically so the
// product feels populated without any backend.
import type { EvidenceMap, Gap, InsightReport, PICO, Project } from "./api";

export const mockPico: PICO = {
...
export const mockProjects: Project[] = [
  {
    ...
    question_text:
      "In adults over 70 with HFpEF, how do SGLT2 inhibitors compare to standard diuretic therapy on hospitalisation and quality of life?",
    status: "review-ready",
  ...
  },
  {
    ...
    question_text:
      "In adolescents with generalised anxiety, does app-delivered CBT reduce symptoms vs in-person therapy?",
    status: "processing",
...
export const mockReport: InsightReport = {
  summary:
    "Evidence concentrates around empagliflozin for hospitalisation and renal function. Mortality evidence is conflicting and quality-of-life outcomes are largely unmeasured across the SGLT2 class.",
  key_clusters: [
  ...
  opportunities: [
    { id: "o1", title: "Trial empagliflozin QoL outcomes in HFpEF >70", linked_gap_id: "g1", clinical_relevance: 0.86, feasibility: 0.72, total_score: 0.80, rationale: "High patient impact, recruitable population, validated QoL instruments available." },
